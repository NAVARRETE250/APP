...
public final class FragmentConexioBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentConexioBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentConexioBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_conexio, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentConexioBinding bind(@NonNull View rootView) {
